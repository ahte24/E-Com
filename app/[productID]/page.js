...
const Page = ({ params }) => {
	...
	const redirectToWhatsApp = () => {
		...
		const whatsappURL = `https://wa.me/9114111987?text=${encodeURIComponent(
			whatsappMessage
		)}`;
		...
		<section className="text-gray-600 body-font overflow-hidden">
			<div className="container px-5 py-10 mx-auto">
				<div className="lg:w-4/5 mx-auto flex flex-wrap">
					<img
						alt="ecommerce"
						className="lg:w-1/2 w-full lg:h-[100vh] h-64 object-cover object-center rounded"
						src={`${endpoint}${productData.image}`}
					/>
